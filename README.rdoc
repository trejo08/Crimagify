...
Edit the file generated for the gem: config/crimagify_versions.yml, with the format mantaining the same ratio for all versions in each blocks, adding models that use images:
